...
const char *ssid =  "TriDung";  //ENTER YOUR WIFI SETTINGS
const char *password = "ADIDAPHAT";
//************************************************************************
String postData ; // post array that will be send to the website

String link = "http://192.168.1.5/biometricattendance/getdata.php"; //computer IP or the server domain

//String link = "http://www.dtehp.com/biometricattendance/getdata.php"; //computer IP or the server domain
